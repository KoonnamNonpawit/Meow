...
public class AssetSetter {
    ...
    public void setObject() {
        ...
        gp.obj[8] = new OBJ_W24();
        gp.obj[8].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[8].worldY = 35 * gp.tileSize;

        gp.obj[474] = new OBJ_W16();
        gp.obj[474].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[474].worldY = 34 * gp.tileSize;
        gp.obj[475] = new OBJ_W24();
        gp.obj[475].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[475].worldY = 35 * gp.tileSize;
        ...
        gp.obj[95] = new OBJ_W16();
        gp.obj[95].worldX = 8 * gp.tileSize + (20 * gp.scale);
        gp.obj[95].worldY = 8 * gp.tileSize;
        gp.obj[96] = new OBJ_W24();
        gp.obj[96].worldX = 8 * gp.tileSize + (20 * gp.scale);
        gp.obj[96].worldY = 9 * gp.tileSize;

        gp.obj[97] = new OBJ_W16();
        gp.obj[97].worldX = 5 * gp.tileSize + (20 * gp.scale);
        gp.obj[97].worldY = 13 * gp.tileSize;
        gp.obj[98] = new OBJ_W24();
        gp.obj[98].worldX = 5 * gp.tileSize + (20 * gp.scale);
        gp.obj[98].worldY = 14 * gp.tileSize;

        gp.obj[99] = new OBJ_W16();
        gp.obj[99].worldX = 41 * gp.tileSize + (20 * gp.scale);
        gp.obj[99].worldY = 10 * gp.tileSize;
        gp.obj[100] = new OBJ_W24();
        gp.obj[100].worldX = 41 * gp.tileSize + (20 * gp.scale);
        gp.obj[100].worldY = 11 * gp.tileSize;

        gp.obj[101] = new OBJ_W16();
        gp.obj[101].worldX = 21 * gp.tileSize + (20 * gp.scale);
        gp.obj[101].worldY = 19 * gp.tileSize;
        gp.obj[102] = new OBJ_W24();
        gp.obj[102].worldX = 21 * gp.tileSize + (20 * gp.scale);
        gp.obj[102].worldY = 20 * gp.tileSize;

        gp.obj[103] = new OBJ_W16();
        gp.obj[103].worldX = 8 * gp.tileSize + (20 * gp.scale);
        gp.obj[103].worldY = 22 * gp.tileSize;
        gp.obj[104] = new OBJ_W24();
        gp.obj[104].worldX = 8 * gp.tileSize + (20 * gp.scale);
        gp.obj[104].worldY = 23 * gp.tileSize;

        gp.obj[105] = new OBJ_W16();
        gp.obj[105].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[105].worldY = 30 * gp.tileSize;
        gp.obj[106] = new OBJ_W24();
        gp.obj[106].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[106].worldY = 31 * gp.tileSize;
        ...
        gp.obj[206].worldX = 10 * gp.tileSize + (2 * gp.scale);
        gp.obj[206].worldY = 4 * gp.tileSize;

        gp.obj[207] = new OBJ_W2();
        gp.obj[207].worldX = 9 * gp.tileSize + (2 * gp.scale);
        ...
        gp.obj[321].worldX = (41 * gp.tileSize) - (2 * gp.scale);
        ...
        gp.obj[388].worldX = 8 * gp.tileSize + (18 * gp.scale);
        gp.obj[388].worldY = 37 * gp.tileSize + (18 * gp.scale);
        ...
        gp.obj[415] = new OBJ_W0();
        gp.obj[415].worldX = 6 * gp.tileSize - (2 * gp.scale);
        gp.obj[415].worldY = 5 * gp.tileSize;

        gp.obj[416] = new OBJ_W0();
        gp.obj[416].worldX = 7 * gp.tileSize - (2 * gp.scale);
        gp.obj[416].worldY = 3 * gp.tileSize;

        gp.obj[417] = new OBJ_W0();
        gp.obj[417].worldX = 8 * gp.tileSize - (2 * gp.scale);
        gp.obj[417].worldY = 2 * gp.tileSize;

        gp.obj[418] = new OBJ_W22();
        gp.obj[418].worldX = 7 * gp.tileSize - (2 * gp.scale);
        gp.obj[418].worldY = 5 * gp.tileSize;

        gp.obj[419] = new OBJ_W8();
        gp.obj[419].worldX = 7 * gp.tileSize - (2 * gp.scale);
        gp.obj[419].worldY = 4 * gp.tileSize;

        gp.obj[420] = new OBJ_W22();
        gp.obj[420].worldX = 8 * gp.tileSize - (2 * gp.scale);
        gp.obj[420].worldY = 3 * gp.tileSize;

        gp.obj[421] = new OBJ_W2();
        gp.obj[421].worldX = 8 * gp.tileSize + (2 * gp.scale);
        gp.obj[421].worldY = 2 * gp.tileSize;

        gp.obj[422] = new OBJ_W18();
        gp.obj[422].worldX = 8 * gp.tileSize + (2 * gp.scale);
        gp.obj[422].worldY = 3 * gp.tileSize;

        gp.obj[423] = new OBJ_W18();
        gp.obj[423].worldX = 9 * gp.tileSize + (2 * gp.scale);
        gp.obj[423].worldY = 4 * gp.tileSize;

        gp.obj[424] = new OBJ_W18();
        gp.obj[424].worldX = 10 * gp.tileSize + (2 * gp.scale);
        gp.obj[424].worldY = 5 * gp.tileSize;

        gp.obj[425] = new OBJ_T3L();
        gp.obj[425].worldX = 6 * gp.tileSize;
        gp.obj[425].worldY = (5 * gp.tileSize) - (10 * gp.scale);
        ...
        gp.obj[427].worldY = 32 * gp.tileSize - (12 * gp.scale);

        gp.obj[428] = new OBJ_SBW();
        gp.obj[428].worldX = 37 * gp.tileSize;
        gp.obj[428].worldY = 28 * gp.tileSize;

        gp.obj[429] = new OBJ_ST6();
        gp.obj[429].worldX = 12 * gp.tileSize - (10 * gp.scale);
        gp.obj[429].worldY = 21 * gp.tileSize;

        gp.obj[430] = new OBJ_ST4();
        gp.obj[430].worldX = 12 * gp.tileSize - (4 * gp.scale);
        gp.obj[430].worldY = 19 * gp.tileSize + (12 * gp.scale);

        gp.obj[431] = new OBJ_ST2();
        gp.obj[431].worldX = 12 * gp.tileSize - (20 * gp.scale);
        gp.obj[431].worldY = 19 * gp.tileSize + (10 * gp.scale);

        gp.obj[432] = new OBJ_PBT6();
        gp.obj[432].worldX = 6 * gp.tileSize;
        gp.obj[432].worldY = 21 * gp.tileSize;

        gp.obj[433] = new OBJ_PBT6();
        gp.obj[433].worldX = 8 * gp.tileSize + (12 * gp.scale);
        gp.obj[433].worldY = 21 * gp.tileSize;

        gp.obj[434] = new OBJ_SBE();
        gp.obj[434].worldX = 5 * gp.tileSize + (8 * gp.scale);
        gp.obj[434].worldY = 19 * gp.tileSize;

        gp.obj[435] = new OBJ_RSW();
        gp.obj[435].worldX = 9 * gp.tileSize;
        gp.obj[435].worldY = 24 * gp.tileSize - (6 * gp.scale);

        gp.obj[436] = new OBJ_PBT4();
        gp.obj[436].worldX = 43 * gp.tileSize;
        gp.obj[436].worldY = 11 * gp.tileSize - (6 * gp.scale);

        gp.obj[437] = new OBJ_P();
        gp.obj[437].worldX = 42 * gp.tileSize + (6 * gp.scale);
        gp.obj[437].worldY = 9 * gp.tileSize - (12 * gp.scale);

        gp.obj[438] = new OBJ_SCH();
        gp.obj[438].worldX = 45 * gp.tileSize - (12 * gp.scale);
        gp.obj[438].worldY = 11 * gp.tileSize - (6 * gp.scale);

        gp.obj[439] = new OBJ_SL();
        gp.obj[439].worldX = 39 * gp.tileSize;
        gp.obj[439].worldY = 9 * gp.tileSize - (6 * gp.scale);

        gp.obj[440] = new OBJ_SBE();
        gp.obj[440].worldX = 35 * gp.tileSize + (10 * gp.scale);
        gp.obj[440].worldY = 8 * gp.tileSize;

        gp.obj[441] = new OBJ_B();
        gp.obj[441].worldX = 34 * gp.tileSize + (6 * gp.scale);
        gp.obj[441].worldY = 9 * gp.tileSize - (4 * gp.scale);

        gp.obj[442] = new OBJ_RSE();
        gp.obj[442].worldX = 38 * gp.tileSize;
        gp.obj[442].worldY = 12 * gp.tileSize - (6 * gp.scale);

        gp.obj[443] = new OBJ_PBT4();
        gp.obj[443].worldX = 29 * gp.tileSize - (22 * gp.scale);
        gp.obj[443].worldY = 46 * gp.tileSize - (4 * gp.scale);

        gp.obj[444] = new OBJ_PBT4();
        gp.obj[444].worldX = 28 * gp.tileSize - (22 * gp.scale);
        gp.obj[444].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[445] = new OBJ_PBT4();
        gp.obj[445].worldX = 27 * gp.tileSize - (22 * gp.scale);
        gp.obj[445].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[446] = new OBJ_PBT4();
        gp.obj[446].worldX = 26 * gp.tileSize - (22 * gp.scale);
        gp.obj[446].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[447] = new OBJ_PBT4();
        gp.obj[447].worldX = 25 * gp.tileSize - (22 * gp.scale);
        gp.obj[447].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[448] = new OBJ_PBT4();
        gp.obj[448].worldX = 24 * gp.tileSize - (22 * gp.scale);
        gp.obj[448].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[449] = new OBJ_PBT4();
        gp.obj[449].worldX = 23 * gp.tileSize - (22 * gp.scale);
        gp.obj[449].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[450] = new OBJ_PBT4();
        gp.obj[450].worldX = 22 * gp.tileSize - (22 * gp.scale);
        gp.obj[450].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[451] = new OBJ_PBT4();
        gp.obj[451].worldX = 21 * gp.tileSize - (22 * gp.scale);
        gp.obj[451].worldY = 46 * gp.tileSize - (6 * gp.scale);

        gp.obj[452] = new OBJ_ST7();
        gp.obj[452].worldX = 29 * gp.tileSize;
        gp.obj[452].worldY = 41 * gp.tileSize;

        gp.obj[453] = new OBJ_ST4();
        gp.obj[453].worldX = 20 * gp.tileSize;
        gp.obj[453].worldY = 43 * gp.tileSize;

        gp.obj[454] = new OBJ_Cr();
        gp.obj[454].worldX = 4 * gp.tileSize;
        gp.obj[454].worldY = 21 * gp.tileSize;

        gp.obj[455] = new OBJ_PoA();
        gp.obj[455].worldX = 3 * gp.tileSize + (9 * gp.scale);
        gp.obj[455].worldY = 21 * gp.tileSize;

        gp.obj[456] = new OBJ_PoB();
        gp.obj[456].worldX = 45 * gp.tileSize - (8 * gp.scale);
        gp.obj[456].worldY = 21 * gp.tileSize;

        gp.obj[457] = new OBJ_SBS();
        gp.obj[457].worldX = 34 * gp.tileSize - (8 * gp.scale);
        gp.obj[457].worldY = 20 * gp.tileSize - (12 * gp.scale);

        gp.obj[458] = new OBJ_PBT4();
        gp.obj[458].worldX = 46 * gp.tileSize - (12 * gp.scale);
        gp.obj[458].worldY = 21 * gp.tileSize - (4 * gp.scale);

        gp.obj[459] = new OBJ_SL();
        gp.obj[459].worldX = 19 * gp.tileSize + (30 * gp.scale);
        gp.obj[459].worldY = 28 * gp.tileSize + (12 * gp.scale);

        gp.obj[460] = new OBJ_SL();
        gp.obj[460].worldX = 23 * gp.tileSize + (12 * gp.scale);
        gp.obj[460].worldY = 28 * gp.tileSize + (12 * gp.scale);

        gp.obj[461] = new OBJ_GA();
        gp.obj[461].worldX = 42 * gp.tileSize;
        gp.obj[461].worldY = 32 * gp.tileSize - (16 * gp.scale);

        gp.obj[462] = new OBJ_LM();
        gp.obj[462].worldX = 4 * gp.tileSize;
        gp.obj[462].worldY = 13 * gp.tileSize;

        gp.obj[463] = new OBJ_BLM();
        gp.obj[463].worldX = 7 * gp.tileSize;
        gp.obj[463].worldY = 8 * gp.tileSize;

        gp.obj[464] = new OBJ_LM();
        gp.obj[464].worldX = 40 * gp.tileSize;
        gp.obj[464].worldY = 10 * gp.tileSize;

        gp.obj[465] = new OBJ_BLM();
        gp.obj[465].worldX = 30 * gp.tileSize;
        gp.obj[465].worldY = 34 * gp.tileSize;

        gp.obj[466] = new OBJ_BML();
        gp.obj[466].worldX = 4 * gp.tileSize - (2 * gp.scale);
        gp.obj[466].worldY = 13 * gp.tileSize;

        gp.obj[467] = new OBJ_BLR();
        gp.obj[467].worldX = 5 * gp.tileSize + (12 * gp.scale);
        gp.obj[467].worldY = 13 * gp.tileSize;

        gp.obj[468] = new OBJ_BML();
        gp.obj[468].worldX = 7 * gp.tileSize - (2 * gp.scale);
        gp.obj[468].worldY = 8 * gp.tileSize;

        gp.obj[469] = new OBJ_BLR();
        gp.obj[469].worldX = 8 * gp.tileSize + (12 * gp.scale);
        gp.obj[469].worldY = 8 * gp.tileSize;

        gp.obj[470] = new OBJ_BML();
        gp.obj[470].worldX = 40 * gp.tileSize - (2 * gp.scale);
        gp.obj[470].worldY = 10 * gp.tileSize;

        gp.obj[471] = new OBJ_BLR();
        gp.obj[471].worldX = 41 * gp.tileSize + (12 * gp.scale);
        gp.obj[471].worldY = 10 * gp.tileSize;

        gp.obj[472] = new OBJ_BML();
        gp.obj[472].worldX = 30 * gp.tileSize - (2 * gp.scale);
        gp.obj[472].worldY = 34 * gp.tileSize;

        gp.obj[473] = new OBJ_BLR();
        gp.obj[473].worldX = 31 * gp.tileSize + (12 * gp.scale);
        gp.obj[473].worldY = 34 * gp.tileSize;
        ...
        gp.obj[509].worldY = (29 * gp.tileSize);

        gp.obj[510] = new OBJ_CrS();
        gp.obj[510].worldX = 3 * gp.tileSize + (12 * gp.scale);
        gp.obj[510].worldY = (25 * gp.tileSize);

        gp.obj[511] = new OBJ_Cr();
        gp.obj[511].worldX = 17 * gp.tileSize + (10 * gp.scale);
        gp.obj[511].worldY = 13 * gp.tileSize;

        gp.obj[512] = new OBJ_SBS();
        gp.obj[512].worldX = 18 * gp.tileSize + (12 * gp.scale);
        gp.obj[512].worldY = 13 * gp.tileSize;

        gp.obj[513] = new OBJ_SBE();
        gp.obj[513].worldX = 17 * gp.tileSize + (12 * gp.scale);
        gp.obj[513].worldY = 14 * gp.tileSize + (6 * gp.scale);

        gp.obj[514] = new OBJ_SCH();
        gp.obj[514].worldX = 22 * gp.tileSize;
        gp.obj[514].worldY = 13 * gp.tileSize;

        gp.obj[515] = new OBJ_PBT4();
        gp.obj[515].worldX = 26 * gp.tileSize - (12 * gp.scale);
        gp.obj[515].worldY = 13 * gp.tileSize - (6 * gp.scale);

        gp.obj[516] = new OBJ_SL();
        gp.obj[516].worldX = 27 * gp.tileSize;
        gp.obj[516].worldY = 14 * gp.tileSize;

        gp.obj[517] = new OBJ_PBT2();
        gp.obj[517].worldX = 27 * gp.tileSize;
        gp.obj[517].worldY = 15 * gp.tileSize;

        gp.obj[518] = new OBJ_SC();
        gp.obj[518].worldX = 27 * gp.tileSize - (10 * gp.scale);
        gp.obj[518].worldY = 16 * gp.tileSize - (16 * gp.scale);

        gp.obj[519] = new OBJ_SBW();
        gp.obj[519].worldX = 26 * gp.tileSize;
        gp.obj[519].worldY = 17 * gp.tileSize;

        gp.obj[520] = new OBJ_RSW();
        gp.obj[520].worldX = 19 * gp.tileSize;
        gp.obj[520].worldY = 18 * gp.tileSize - (4 * gp.scale);

        gp.obj[521] = new OBJ_T3L();
        gp.obj[521].worldX = 21 * gp.tileSize;
        gp.obj[521].worldY = (15 * gp.tileSize);/////////////////////
        ...
        gp.obj[523].worldY = (15 * gp.tileSize);

        gp.obj[524] = new OBJ_PBT2();
        ...
        gp.obj[526].worldY = 24 * gp.tileSize;

        gp.obj[527] = new OBJ_ST7();
        gp.obj[527].worldX = 40 * gp.tileSize;
        gp.obj[527].worldY = 22 * gp.tileSize;

        gp.obj[528] = new OBJ_Cr();
        gp.obj[528].worldX = 42 * gp.tileSize;
        gp.obj[528].worldY = 23 * gp.tileSize;

        gp.obj[529] = new OBJ_CrS();
        gp.obj[529].worldX = 43 * gp.tileSize;
        gp.obj[529].worldY = 22 * gp.tileSize;

        gp.obj[530] = new OBJ_SCH();
        gp.obj[530].worldX = 44 * gp.tileSize;
        gp.obj[530].worldY = 22 * gp.tileSize - (6 * gp.scale);

        gp.obj[531] = new OBJ_PBT6();
        gp.obj[531].worldX = 46 * gp.tileSize - (12 * gp.scale);
        gp.obj[531].worldY = 23 * gp.tileSize - (6 * gp.scale);

        gp.obj[532] = new OBJ_PBT4();
        gp.obj[532].worldX = 45 * gp.tileSize;
        gp.obj[532].worldY = 26 * gp.tileSize;

        gp.obj[533] = new OBJ_SL();
        gp.obj[533].worldX = 41 * gp.tileSize - (6 * gp.scale);
        gp.obj[533].worldY = 28 * gp.tileSize - (6 * gp.scale);

        gp.obj[534] = new OBJ_SBE();
        gp.obj[534].worldX = 42 * gp.tileSize;
        gp.obj[534].worldY = 28 * gp.tileSize - (28 * gp.scale);

        gp.obj[535] = new OBJ_SC();
        gp.obj[535].worldX = 44 * gp.tileSize;
        gp.obj[535].worldY = 28 * gp.tileSize - (16 * gp.scale);

        gp.obj[536] = new OBJ_SBW();
        gp.obj[536].worldX = 46 * gp.tileSize;
        gp.obj[536].worldY = 28 * gp.tileSize - (28 * gp.scale);
        ...
        gp.obj[539].worldY = 32 * gp.tileSize;

        gp.obj[540] = new OBJ_PBT2();
        gp.obj[540].worldX = 37 * gp.tileSize;
        gp.obj[540].worldY = 33 * gp.tileSize;

        gp.obj[541] = new OBJ_P();
        gp.obj[541].worldX = 10 * gp.tileSize;
        gp.obj[541].worldY = 35 * gp.tileSize;

        gp.obj[542] = new OBJ_SBW();
        gp.obj[542].worldX = 12 * gp.tileSize;
        gp.obj[542].worldY = 36 * gp.tileSize;

        gp.obj[543] = new OBJ_SBW();
        gp.obj[543].worldX = 14 * gp.tileSize;
        gp.obj[543].worldY = 39 * gp.tileSize;

        gp.obj[544] = new OBJ_SL();
        gp.obj[544].worldX = 18 * gp.tileSize + (6 * gp.scale);
        gp.obj[544].worldY = 40 * gp.tileSize - (6 * gp.scale);

        gp.obj[545] = new OBJ_PB();
        gp.obj[545].worldX = 15 * gp.tileSize;
        gp.obj[545].worldY = 35 * gp.tileSize;

        gp.obj[546] = new OBJ_GB();
        gp.obj[546].worldX = 15 * gp.tileSize;
        gp.obj[546].worldY = 40 * gp.tileSize - (18 * gp.scale);

        gp.obj[547] = new OBJ_PB();
        gp.obj[547].worldX = 10 * gp.tileSize;
        gp.obj[547].worldY = 39 * gp.tileSize;

        gp.obj[548] = new OBJ_W();
        gp.obj[548].worldX = 8 * gp.tileSize;
        gp.obj[548].worldY = 38 * gp.tileSize;

        gp.obj[549] = new OBJ_PBT2();
        gp.obj[549].worldX = 7 * gp.tileSize + (18 * gp.scale);
        gp.obj[549].worldY = 37 * gp.tileSize + (12 * gp.scale);

        gp.obj[550] = new OBJ_PBT6();
        gp.obj[550].worldX = 8 * gp.tileSize;
        gp.obj[550].worldY = 40 * gp.tileSize;

        gp.obj[551] = new OBJ_ST7();
        gp.obj[551].worldX = 8 * gp.tileSize;
        gp.obj[551].worldY = 36 * gp.tileSize;

        gp.obj[552] = new OBJ_PBT4();
        gp.obj[552].worldX = 9 * gp.tileSize;
        gp.obj[552].worldY = 40 * gp.tileSize;

        gp.obj[553] = new OBJ_SBE();
        gp.obj[553].worldX = 33 * gp.tileSize;
        gp.obj[553].worldY = 37 * gp.tileSize;

        gp.obj[554] = new OBJ_SBS();
        gp.obj[554].worldX = 34 * gp.tileSize;
        gp.obj[554].worldY = 36 * gp.tileSize;

        gp.obj[555] = new OBJ_SBW();
        gp.obj[555].worldX = 36 * gp.tileSize;
        gp.obj[555].worldY = 37 * gp.tileSize;

        gp.obj[556] = new OBJ_PB();
        gp.obj[556].worldX = 38 * gp.tileSize;
        gp.obj[556].worldY = 35 * gp.tileSize;

        gp.obj[557] = new OBJ_ST2();
        gp.obj[557].worldX = 39 * gp.tileSize + (18 * gp.scale);
        gp.obj[557].worldY = 37 * gp.tileSize - (6 * gp.scale);

        gp.obj[558] = new OBJ_ST6();
        gp.obj[558].worldX = 40 * gp.tileSize;
        gp.obj[558].worldY = 36 * gp.tileSize + (10 * gp.scale);

        gp.obj[559] = new OBJ_T3L();
        gp.obj[559].worldX = 38 * gp.tileSize;
        gp.obj[559].worldY = (39 * gp.tileSize) - (10 * gp.scale);/////////////////////////
        ...
        gp.obj[561].worldY = 40 * gp.tileSize;

        gp.obj[562] = new OBJ_SL();
        gp.obj[562].worldX = 31 * gp.tileSize;
        gp.obj[562].worldY = 40 * gp.tileSize - (6 * gp.scale);

        gp.obj[563] = new OBJ_SBS();
        gp.obj[563].worldX = 26 * gp.tileSize;
        gp.obj[563].worldY = 36 * gp.tileSize - (12 * gp.scale);

        gp.obj[564] = new OBJ_Cr();
        gp.obj[564].worldX = 23 * gp.tileSize + (12 * gp.scale);
        gp.obj[564].worldY = 36 * gp.tileSize - (12 * gp.scale);

        gp.obj[565] = new OBJ_SBS();
        gp.obj[565].worldX = 20 * gp.tileSize;
        gp.obj[565].worldY = 36 * gp.tileSize - (12 * gp.scale);

        gp.obj[566] = new OBJ_PBT4();
        gp.obj[566].worldX = 25 * gp.tileSize - (12 * gp.scale);
        gp.obj[566].worldY = 36 * gp.tileSize - (12 * gp.scale);

        gp.obj[567] = new OBJ_PBT4();
        gp.obj[567].worldX = 22 * gp.tileSize - (10 * gp.scale);
        gp.obj[567].worldY = 36 * gp.tileSize - (12 * gp.scale);

        gp.obj[568] = new OBJ_ST2();
        gp.obj[568].worldX = 8 * gp.tileSize + (8 * gp.scale);
        gp.obj[568].worldY = 37 * gp.tileSize + (6 * gp.scale);

        gp.obj[569] = new OBJ_ST6();
        gp.obj[569].worldX = 7 * gp.tileSize + (8 * gp.scale);
        gp.obj[569].worldY = 36 * gp.tileSize;

        gp.obj[570] = new OBJ_PBT6();
        gp.obj[570].worldX = 11 * gp.tileSize;
        gp.obj[570].worldY = 36 * gp.tileSize - (18 * gp.scale);

        gp.obj[571] = new OBJ_PoC();
        gp.obj[571].worldX = 31 * gp.tileSize + (20 * gp.scale);
        gp.obj[571].worldY = 21 * gp.tileSize - (12 * gp.scale);

        gp.obj[572] = new OBJ_SBW();
        gp.obj[572].worldX = 35 * gp.tileSize + (2 * gp.scale);
        gp.obj[572].worldY = 22 * gp.tileSize;

        gp.obj[573] = new OBJ_ST7();
        gp.obj[573].worldX = 28 * gp.tileSize;
        gp.obj[573].worldY = 22 * gp.tileSize;

        gp.obj[574] = new OBJ_Cr();
        gp.obj[574].worldX = 30 * gp.tileSize;
        gp.obj[574].worldY = 27 * gp.tileSize - (16 * gp.scale);

        gp.obj[575] = new OBJ_CrS();
        gp.obj[575].worldX = 31 * gp.tileSize;
        gp.obj[575].worldY = 26 * gp.tileSize;

        gp.obj[576] = new OBJ_PoA();
        gp.obj[576].worldX = 26 * gp.tileSize;
        gp.obj[576].worldY = 21 * gp.tileSize - (12 * gp.scale);

        gp.obj[577] = new OBJ_PBT4();
        gp.obj[577].worldX = 21 * gp.tileSize;
        gp.obj[577].worldY = 21 * gp.tileSize;

        gp.obj[578] = new OBJ_Cr();
        gp.obj[578].worldX = 19 * gp.tileSize + (4 * gp.scale);
        gp.obj[578].worldY = 27 * gp.tileSize - (16 * gp.scale);

        gp.obj[579] = new OBJ_SC();
        gp.obj[579].worldX = 29 * gp.tileSize;
        gp.obj[579].worldY = 27 * gp.tileSize - (16 * gp.scale);

        gp.obj[580] = new OBJ_ST4();
        gp.obj[580].worldX = 29 * gp.tileSize + (8 * gp.scale);
        gp.obj[580].worldY = 21 * gp.tileSize + (18 * gp.scale);
    }
}
